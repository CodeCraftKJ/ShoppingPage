...
const Hero: NextPage = () => {
  ...
  return (
    <div className="self-stretch bg-white flex flex-col pt-[0rem] px-[4.69rem] pb-[2.75rem] items-center justify-start text-left text-[4.5rem] text-black font-poppins md:pl-[2.5rem] md:pr-[2.5rem] md:box-border sm:pl-[1.25rem] sm:pr-[1.25rem] sm:box-border">
      <div className="self-stretch rounded-[44.26px] bg-whitesmoke-100 flex flex-row pt-[3.19rem] px-[2.5rem] pb-[0.13rem] items-center justify-center gap-[2.38rem] lg:flex-col">
        <div className="flex flex-col py-[0rem] pr-[0rem] pl-[1.73rem] items-start justify-start relative gap-[1.69rem] sm:pl-[0rem] sm:box-border">
          ...
          <div className="flex flex-row items-center justify-start gap-[1.59rem] z-[4]">
            ...
            />
            <button
              className="cursor-pointer [border:none] py-[0.81rem] px-[1.88rem] bg-black rounded-5xs-5 flex flex-row items-start justify-start hover:bg-darkslategray sm:pl-[0.94rem] sm:pr-[0.94rem] sm:box-border"
