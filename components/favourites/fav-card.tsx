...
const FavCard: NextPage<FavCardType> = ({ cardImage, cardLink = "" }) => {
      ...
      <div className="self-stretch flex flex-row items-center justify-between">
        <div className="flex flex-col items-start justify-start gap-[0.33rem]">
          ...
          <div
            ...
            className="relative text-[1.13rem] tracking-[-0.04em] leading-[2.34rem] font-medium text-gray-300 inline-block w-[6.84rem] h-[1.55rem] shrink-0 md:text-[0.94rem]"
          >
            Explore Now!
          </div>
        </div>
